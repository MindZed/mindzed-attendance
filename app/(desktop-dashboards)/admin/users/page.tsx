...
import { Plus, X, Shield, BookOpen, GraduationCap, Users, Loader2, Trash2, Edit, AlertTriangle } from "lucide-react";
import { createSystemUser, getUsersByRole, deleteSystemUser, updateSystemUser } from "@/lib/actions/admin/crud";
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm transition-opacity">
          <div className="bg-white dark:bg-neutral-900 rounded-2xl shadow-xl w-full max-w-lg overflow-hidden max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center p-6 border-b border-gray-100 dark:border-neutral-800 sticky top-0 bg-white dark:bg-neutral-900 z-10">
              ...
              <button onClick={() => { setIsModalOpen(false); setEditingUser(null); }} className="text-gray-400 hover:text-gray-700 transition"><X className="w-6 h-6" /></button>
            </div>
            ...
            <form action={handleSubmit} className="p-6 space-y-5">
              <div>
                ...
                <select value={newUserRole} onChange={(e) => setNewUserRole(e.target.value as RoleTab)} disabled={!!editingUser} name="role" className="w-full px-4 py-2.5 bg-gray-50 dark:bg-neutral-800 text-gray-900 dark:text-white border border-gray-200 dark:border-neutral-700 rounded-lg outline-none disabled:opacity-50">
